...
<dl class="leftmenu">
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="user_manager/addUser.jsp" target="rightFrame">添加用户</a><i></i></li>
            <li><cite></cite><a href="user_manager/findUser.jsp" target="rightFrame">查询用户</a><i></i></li>
